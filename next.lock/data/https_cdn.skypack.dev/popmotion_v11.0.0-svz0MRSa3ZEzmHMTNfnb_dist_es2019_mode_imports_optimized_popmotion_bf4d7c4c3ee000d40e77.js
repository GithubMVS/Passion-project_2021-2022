import {__rest} from "/-/tslib@v2.3.1-oagOtGnmjZ2E5Gt5m3zI/dist=es2019,mode=imports/optimized/tslib.js";
import {warning, invariant} from "/-/hey-listen@v1.0.8-DaoRGtiIN5jALXMTSi5i/dist=es2019,mode=imports/optimized/hey-listen.js";
import {hsla, rgba, hex, complex, color} from "/-/style-value-types@v5.0.0-gjc2oqEAVasUJgdjUaWt/dist=es2019,mode=imports/optimized/style-value-types.js";
import sync, {cancelSync, getFrameData} from "/-/framesync@v6.0.1-QE2X8mQ3Kj0W1HbKEgM4/dist=es2019,mode=imports/optimized/framesync.js";
...
function animate(_a) {
  var _b, _c;
  var {from, autoplay = true, driver = framesync2, elapsed = 0, repeat: repeatMax = 0, repeatType = "loop", repeatDelay = 0, onPlay, onStop, onComplete, onRepeat, onUpdate} = _a, options = __rest(_a, ["from", "autoplay", "driver", "elapsed", "repeat", "repeatType", "repeatDelay", "onPlay", "onStop", "onComplete", "onRepeat", "onUpdate"]);
  let {to} = options;
  let driverControls;
  let repeatCount = 0;
